...
<head>
    ...
    <title>Farmer - Recycle Bin</title>
...
<li class="breadcrumb-item" aria-current="page">
  <label style="color: black"> Farmers </label>
</li>
...
<button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#deleteallfarmerrecyclebin">
<i class="fa fa-trash">&nbsp;</i>Delete All</button>
<?php include 'delete-farmer-allrecyclebin-modal.php'; ?>
</div>
</div>
...
<?php
$query=mysqli_query($con,"SELECT * FROM tblfarmer_backup ORDER BY id DESC");
while($row=mysqli_fetch_array($query))
{    
?>                                                
<tr>
<td>
<button type="button" class="btn btn-outline-primary icon-refresh" data-toggle="modal" data-target="#restorerecyclebinfarmer<?php echo $row['id'];?>"></button>
<button type="button" class="btn btn-outline-danger icon-trash" data-toggle="modal" data-target="#deleterecyclebinfarmer<?php echo $row['id'];?>"></button>
</td>
...
<?php 
  include 'delete-farmer-recyclebin-modal.php';
  include 'restore-farmer-recyclebin-modal.php';
} ?>
</tbody>
</table>
</div>
