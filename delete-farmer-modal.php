<!--FORM MODAL-->
<div class="modal fade" id="deletefarmer<?php echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<div class="row">
<div class="col-sm">
<form action="delete-farmer-process.php" method="post">
