<!--FORM MODAL-->
<div class="modal fade" id="restorerecyclebinuser<?php echo $row['ID'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<div class="row">
<div class="col-sm">
<form action="restore-user-recyclebin-process.php" method="post">
...
<button class="btn btn-primary col-md-6 mb-10" type="submit" name="submit_backupusers">Yes</button>
