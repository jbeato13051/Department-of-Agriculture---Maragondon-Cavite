...
<head>
    ...
    <title>Report Damaged Products - Recycle Bin</title>
...
<li class="breadcrumb-item" aria-current="page">
  <label style="color: black"> Report Damaged Products </label>
</li>
...
<button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#deletereportdamageallrecyclebinmodal">
<i class="fa fa-trash">&nbsp;</i>Delete All</button>
<?php include 'delete-report-damage-allrecyclebin-modal.php'; ?>
</div>
</div>
...
<?php
$query=mysqli_query($con,"SELECT * FROM tblreportdamage_backup ORDER BY id DESC");
while($row=mysqli_fetch_array($query))
{    
?>                                                
<tr>
<td>
<button type="button" class="btn btn-outline-primary icon-refresh" data-toggle="modal" data-target="#restorerecyclebinreportdamage<?php echo $row['id'];?>"></button>
<button type="button" class="btn btn-outline-danger icon-trash" data-toggle="modal" data-target="#deleterecyclebinreportdamage<?php echo $row['id'];?>"></button>
</td>
...
<?php 
  include 'delete-report-damage-recyclebin-modal.php';
  include 'restore-report-damage-recyclebin-modal.php';
} ?>
</tbody>
</table>
</div>
