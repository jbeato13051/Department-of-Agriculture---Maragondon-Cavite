<!--FORM MODAL-->
<div class="modal fade" id="deleterecyclebinreportharvested<?php echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<div class="row">
<div class="col-sm">
<form action="delete-report-harvested-recyclebin-process.php" method="post">
