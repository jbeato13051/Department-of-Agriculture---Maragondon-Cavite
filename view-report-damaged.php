...
<br>
<tr class="heading">
    <h2>Report Damaged Product Details</h2>
</tr>
<br>

<?php
$id=$_GET['id'];
$query=mysqli_query($con,"select * from tblreportdamage where id='$id'");
...
<h4>Area Harvested(ha) </h4><?php echo $row['AreaDamage_hectares'];?>&nbsp;hectare/s<br>
<h4>Gross Harvest(bag) </h4><?php echo $row['GrossDamage_bag'];?>&nbsp;bag/s<br>
