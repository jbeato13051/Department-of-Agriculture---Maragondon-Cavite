<!--FORM MODAL-->
<div class="modal fade" id="editreportdamaged<?php echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered" role="document">
<div class="modal-content">
<div class="modal-header">
<h5 class="modal-title" id="exampleModalCenterTitle"><span class="pg-title-icon"><span class="feather-icon"></span>
<i class="ion ion-ios-list-box" style="color: black"></i> </span>Edit Report Damaged Product</h5>
...
<div class="row">
<div class="col-sm">
<form action="edit-report-damaged-process.php" method="POST">
...
<input type="number" class="form-control border border-dark" pattern="[0-9]+([\.,][0-9]+)?" step="0.01" title="Please enter on number or number with up to 2 decimal places only" value="<?php echo $row['AreaDamage_hectares'];?>" placeholder="Enter area damaged(hectare/s)" name="AreaDamage_hectares" id="AreaDamage_hectares" required>
</div>
</div>
...
<input type="number" class="form-control border border-dark" value="<?php echo $row['GrossDamage_bag'];?>" placeholder="Enter gross damaged(bag/s)" name="GrossDamage_bag" id="GrossDamage_bag" required>
</div>
</div>
