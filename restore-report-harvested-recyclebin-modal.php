<!--FORM MODAL-->
<div class="modal fade" id="restorerecyclebinreportharvested<?php echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<div class="row">
<div class="col-sm">
<form action="restore-report-harvested-recyclebin-process.php" method="post">
...
<button class="btn btn-primary col-md-6 mb-10" type="submit" name="submit_backupharvested">Yes</button>
